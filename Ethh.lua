...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "ethantherizzler_1"})
    creditsSection:AddText({text = "bobby.11.2"})
    creditsSection:AddSeparator({text = 'Helpers'});
    creditsSection:AddText({text = "darkcoded_"})
    creditsSection:AddText({text = "qurexa.dev_22937"})
